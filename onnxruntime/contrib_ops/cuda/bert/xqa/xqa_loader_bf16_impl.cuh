...
Status LaunchXQAKernelImpl<__nv_bfloat16>(
  ...
  switch (group_size) {
    ...
    case 5:
      return grp5_bf16::Launch<__nv_bfloat16>(device_prop, stream, query, key_cache, value_cache, output, batch_size, num_heads, kv_num_heads, head_size, max_seq_len, scale, is_bsnh, past_seq_lens, kv_cache_scale, workspace, workspace_size);
    case 8:
